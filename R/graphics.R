...
#' @param mcl_matrix AnalyzeOrthoMCL output
...
#' @param mcl_data FormatAfterOrtho output
...
#' @param mcl_mtrx matrix generated by AnalyzeOrthoMCL
#' @return a qqplot of the p-values obtained through AnalyzeOrthoMCL
...
#' @param mcl_data FormatAfterOrtho output
#' @param mcl_mtrx output of AnalyzeOrthoMCL()
...
ManhatGrp <- function(mcl_data, mcl_mtrx, tree = NULL) {
    ...
    #  uncorrected
    #pvalue <- data.frame(Gene = mcl_mtrx[, "OG"], PValue = (mcl_mtrx[, 2]))
